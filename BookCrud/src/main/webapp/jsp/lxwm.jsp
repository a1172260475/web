...
<div class="header" style="height: 160px;">
    <div class="main">
        <div class="logo"><title="好好吃饭"><img src="../img/title.png" alt="好好吃饭" /></a></div>
...
<div class="product sub_pro">
    ...
    <div class="product02">
        <div class="content_com_title">
            <h2>联系我们</h2>
            <div class="bread">当前位置：<a href="/">首页</a> > <a href="zaixianliuyan.html">联系我们</a></div>
        </div>
        <div class="content">
            <div class="view">
                <p><p style="text-align: center;"><img src="../img/cc.jpg" style="float:none;"></p><p style="text-align: center;"><iframe class="ueditor_baidumap" src="http://hnnrtjd.com/adminbo/ueditor/dialogs/map/show.html#center=116.86605,32.601054&zoom=18&width=530&height=340&markers=116.866373,32.601442&markerStyles=l,A" frameborder="0" width="534" height="344"></iframe></p><p><br/></p></p>
            </div>
        </div>
    </div>
    <div class="clear"></div>
...
<div class="manager_info">
    <div class="main">
        <div class="fl"><span>版权所有&#169;2018-2019 好好吃饭</span><span>技术支持：<a title="呵" target="_blank" >呵</a></span></div>
